...
## [Day 06](https://adventofcode.com/2025/day/6) [Solutions](06/)

This problem was relatively straight forward for both parts 1 and 2.
Part 2 was a little more difficult in that it forced the construction 
of number across the text lines.  In this problem I became a little
more comfortable with dynamic arrays and slices and converting strings
to numbers.  The essence of part 2 is as follows:
